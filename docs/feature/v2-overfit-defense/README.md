...
| Sprint 2 | CPCV CLI + Regime check + Param stability | complete; review fixes applied |
...
- [sprint2/sprint2-backend.md](./sprint2/sprint2-backend.md) — Sprint 2 complete; review fixes synced and ready for review
