...
| Sprint 1 — Autoresearch Core | define loop semantics and idea-ingestion lane | issue #18, sprint1 backend/infra docs, PR #23 | completed | proceed to Sprint 3 |
| Sprint 2 — Minute Runtime | align runtime/data/validation to the minute-level mission | issue #19, sprint2 backend/infra docs, PR #24 | completed | proceed to Sprint 3 |
