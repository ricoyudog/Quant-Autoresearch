...
This project is indexed by GitNexus as **Quant-Autoresearch** (3874 symbols, 6727 relationships, 182 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
