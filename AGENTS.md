...
This project is indexed by GitNexus as **Quant-Autoresearch** (3867 symbols, 6720 relationships, 182 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
